...
- Держать `typespec/main.tsp`, `docs/openapi.yaml` и `docs/api-contract.md` синхронизированными с implementation.
...
- Double booking должен отклоняться сервером даже между разными типами событий.
- Public booking window ограничен ближайшими 14 календарными днями.
