...
Не добавлять внешние календарные интеграции, платежи, команды, OAuth, публичную регистрацию, email-доставку или несколько типов встреч без явного запроса.
...
- Держать API-контракт в `docs/api-contract.md` синхронизированным с реализацией.
...
- Для MVP оставить одного владельца календаря и один тип встречи.
...
- Приложение слушает `0.0.0.0:3000` внутри контейнера.
